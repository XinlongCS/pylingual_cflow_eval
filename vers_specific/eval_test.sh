...
for version in 3.6 3.7 3.8 3.9 3.10 3.11 3.12 3.13; do
    ...
    python ~/pylingual_eval/parse_results.py "/tmp/cflow_test/${version}/py${version_underscore}_files_0/results.json" > "${version}/${new_num}results${version_underscore}.txt"
    echo "----------------------------------"
done
